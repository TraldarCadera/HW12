...
public class Threads {
    ...
    public void oneThread() {
        ...
        calculate(arr);
        System.out.println("Первый поток завершил свою работу за: " + (System.currentTimeMillis() - a));
    }
    ...
    public void twoThreads() {
        ...
        System.out.println("Второй поток закончил свою работу за: " + (System.currentTimeMillis() - a));
    }
}
